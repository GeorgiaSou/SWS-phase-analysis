%% Rs and Corrs - UP-STATE STIMULATION

clear all; close all;

StimCh=[13 15 20 27 28 29 30 104 112 117 118 122 123 124];

ch_inc=[13 20 27 28 29 30];
ch_dec=[112 117 118 122 123 124];
...
cd('D:\SWS_Chord_PN\data\Ratios\up\')
load('Phase_trigs_allSubs_FH')

cd('D:\SWS_Chord_PN\data\Ratios\up\0.5-2 Hz')
load('ratios_FH')
